                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                                ...
                                case "enable":
                                    ...
                                    if (a.p.unwritten) {
                                        ...
                                        if (d == 1) {
                                            ...
                                            b("#load_" + c).next().find('.ui-jqgrid-bdiv').append('<div class="no-data"></div>');
                                        } else {
                                            b("#load_" + c).next().find('.ui-jqgrid-bdiv').find(".no-data").remove();
                                        }
                                    }
                                    break;
                                case "block":
                        ...
                        qa = function (c, e) {
                            ...
                            "ltr" === f && (g += k);
                            g += "</tr></tbody></table>"; !0 === a.p.viewrecords && b("td#" + c + "_" + a.p.recordpos, "#" + l).append("<div dir='" + f + "' style='text-align:right' class='ui-paging-info'></div>");
