...
$.fn.Tab = function (options) {
    ...
    //alert(obj.closest(".content-tabs").next().attr("id"))
    //obj.parent().parent().parent().append('').append(tabContent);
    //var obj = $(this).append(tabH).append(container.append(tabContenter)).append(tabContent);
    ...
    //    //cfg.tabcontentWidth = $(window).width() - $("#sidebar").width() + 2;//- 80;
