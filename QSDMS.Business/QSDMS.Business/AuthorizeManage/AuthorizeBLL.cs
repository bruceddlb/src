...
namespace QSDMS.Business
{
    ...
    /// 描 述：授权认证
    /// </summary>
    public class AuthorizeBLL : BaseBLL<IAuthorizeService>, IAuthorizeService
    {       
        ...
        /// 访问实例
        /// </summary>
        private static AuthorizeBLL m_Instance = new AuthorizeBLL();

        /// <summary>
        /// 访问实例
        /// </summary>
        public static AuthorizeBLL Instance
        {
        ...
        public IEnumerable<ModuleEntity> GetModuleList(string userId)
        {
            ...
            {
                return InstanceDAL.GetModuleList(userId);
            }
        }
        /// <summary>
        /// 获取授权功能按钮
        ...
        public IEnumerable<ModuleButtonEntity> GetModuleButtonList(string userId)
        {
            ...
            {
                return InstanceDAL.GetModuleButtonList(userId);
            }
        }
        /// <summary>
        /// 获取授权功能视图
        ...
        public IEnumerable<ModuleColumnEntity> GetModuleColumnList(string userId)
        {
            ...
            {
                return InstanceDAL.GetModuleColumnList(userId);
            }
        }
        /// <summary>
        /// 获取授权功能Url、操作Url
        ...
        {
            return InstanceDAL.GetUrlList(userId);
        }
        /// <summary>
        /// Action执行权限认证
        /// </summary>
        ...
        {
            return InstanceDAL.GetDataAuthorUserId(operators, isWrite);
        }
        /// <summary>
        /// 获得可读数据权限范围SQL
        /// </summary>
        ...
        {
            return InstanceDAL.GetDataAuthor(operators, isWrite);
        }
