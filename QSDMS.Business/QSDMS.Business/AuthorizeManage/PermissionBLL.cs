...
namespace QSDMS.Business
{
    ...
    /// </summary>
    public class PermissionBLL : BaseBLL<IPermissionService>
    {
        /// <summary>
        /// 访问实例
        /// </summary>
        private static PermissionBLL m_Instance = new PermissionBLL();
        ...
        {
            return InstanceDAL.GetMemberList(objectId);
        }
        /// <summary>
        /// 获取对象列表
        /// </summary>
        ...
        {
            return InstanceDAL.GetObjectList(userId);
        }
        /// <summary>
        /// 获取对象列表
        /// </summary>
        ...
        public string GetObjectStr(string userId)
        {
            ...
            List<UserRelationEntity> list = InstanceDAL.GetObjectList(userId).ToList();
            if (list.Count > 0)
            {
        ...
        {
            return InstanceDAL.GetModuleList(objectId);
        }
        /// <summary>
        /// 获取按钮列表
        /// </summary>
        ...
        {
            return InstanceDAL.GetModuleButtonList(objectId);
        }
        /// <summary>
        /// 获取视图列表
        /// </summary>
        ...
        {
            return InstanceDAL.GetModuleColumnList(objectId);
        }
        /// <summary>
        /// 获取数据权限列表
        /// </summary>
        ...
        {
            return InstanceDAL.GetAuthorizeDataList(objectId);
        }
        #endregion
        ...
        public void SaveMember(AuthorizeTypeEnum authorizeType, string objectId, string userIds)
        {
            try
            {
                ...
                InstanceDAL.SaveMember(authorizeType, objectId, arrayUserId);
            }
            catch (Exception)
            {
                throw;
