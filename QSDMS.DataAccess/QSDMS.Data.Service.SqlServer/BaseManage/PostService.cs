...
namespace QSDMS.Data.Service.SqlServer
{
    ...
    public class PostService : IPostService
    {
        ...
        {
            var sql = PetaPoco.Sql.Builder.Append(@"select * from Base_Role where 1=1 and Category=@0 and EnabledMark=1 and DeleteMark=0", (int)QSDMS.Model.Enums.RoleCategoryEnum.岗位);
        ...
        {
            var sql = PetaPoco.Sql.Builder.Append(@"select * from Base_Role where 1=1 and Category=@0", (int)QSDMS.Model.Enums.RoleCategoryEnum.岗位);
        ...
        public IEnumerable<RoleEntity> GetAllList()
        {
            ...
            strSql.AppendFormat(@"SELECT  r.RoleId ,
                    ...
                    ORDER BY o.FullName, r.SortCode", (int)QSDMS.Model.Enums.RoleCategoryEnum.岗位);
